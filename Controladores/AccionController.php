...
class AccionController 
{
    ...
    public function listado_auditoria($mensaje = null, $id_filtro = null, $filtro = null)
    {
        ...
        if (!isset($_SESSION["Usuario"])) {
            ...
            include("./Views/view_auditoria.php");
        }
        exit();
    }

    public function listado_auditoria_control($filtro_nombre = null, $filtro_id = null)
    {
        $filtro = $_REQUEST["filtro"];
        $id_filtro = $_REQUEST["ID_Filtro"];
        header("Location: /auditoria?filtro=" . $filtro_nombre . "&ID_Filtro=" . $filtro_id);
        exit();
    }
}