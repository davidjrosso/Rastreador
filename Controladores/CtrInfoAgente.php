...
$Consulta2 = mysqli_query($Con->Conexion,"select G.Fecha2, G.nroRemito, C.TipoConbu, V.Detalle, V.Dominio, G.Precio, G.LitrosCombustible, A.Leg, A.Apellido, A.Nombre, AR.Area from general G, combus C,agen A,vehi V, area AR where AR.IdArea = A.Area and A.IDAgente = G.Agente and V.idVehi = G.Vehiculo and C.IdConbus = G.Combustible and A.IDAgente = $Agente and G.Fecha2 between '$Fecha1' and '$Fecha2' order by G.Fecha2 ")or die("Problemas en la consulta");
