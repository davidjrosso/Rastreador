...
$Fecha = Date("Y-m-d");
$ID_Registro_1 = $_REQUEST["ID_Persona_1"];
$ID_Registro_2 = $_REQUEST["ID_Persona_2"];
...
if($ID_Registro_1 > 0 && $ID_Registro_2 > 0){
	...
	header('Location: ../view_unifpersonas.php?Mensaje='.$Mensaje);
}else{
	$MensajeError = "Debe seleccionar Primer Persona y Segunda Persona";
	header('Location: ../view_unifpersonas.php?MensajeError='.$MensajeError);
}
