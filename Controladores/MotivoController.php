...
class MotivoController 
{
    ...
    public function mod_motivo($id_motivo)
    {
        ...
        if (!isset($_SESSION["Usuario"])) {
            ...
            if(isset($_REQUEST["ID"])) {
                ...
                $Codigo = $motivo->get_codigo();
                $Cod_Categoria = $motivo->get_cod_categoria();
                $Num_Motivo = $motivo->get_num_motivo();
                $Estado = $motivo->get_estado();

                $ID_Categoria = Categoria::exist_cod_categoria(connection: $Con, cod_categoria: $Cod_Categoria);
    ...
    function mod_motivo_control()
    {
        ...
        try {
            ...
            $sl = new Solicitud_ModificarMotivo(xID: $ID_Solicitud );
    ...
    public function new_motivo_ctrl()
    {
        ...
        try	 {
           ...
           if (Motivo::existe_motivo_con_nombre($Con, $Motivo) > 0) {
    ...
    public function new_motivo_control()
    {
        ...
        try	 {
           ...
           if (Motivo::existe_motivo_con_nombre($Con, $Motivo)) {
                $Con->CloseConexion();
