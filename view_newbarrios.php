      ...
      <div class = "col-10">
          ...
          <form method = "post" onKeydown="return event.key != 'Enter';" action = "Controladores/InsertBarrio.php">
            <div class="form-group row">
              ...
              <div class="col-md-10">
                <input type="text" class="form-control" name = "Barrio" id="Barrio" autocomplete="off" required>
              </div>
            </div>
            <div class="form-group row">
          ...
          <div class="row">
              ...
              <div class="col-2">
                <button type = "button" class = "btn btn-outline-secondary" onClick = "location.href = 'view_barrios.php'">Volver</button>
              </div>
          </div>
          <!-- Fin Carga -->
  </div>
