...
<head>
  ...
  <script src="js/ValidarMovFechas.js"></script>
  ...
  <div class = "col-md-9">
    ...
    <br>
     <div class = "row">
      <div class = "col-10">
           <!-- Carga -->
          <form method = "post" onKeydown="return event.key != 'Enter';" action = "view_vermovfechas.php" onSubmit = "return ValidarMovFechas();">
