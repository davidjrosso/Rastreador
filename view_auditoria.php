...
<body>
  <div class="row">
    ...
    echo $Element->menuDeNavegacion(
      ...
      pagina: $Element::PAGINA_AUDITORIA_ACCION
    );
    ?>
    <div class="col-md-9">
      <div class="row">
      ...
      <div class="row">
        <div class="col"></div>
        <div class="col-4">
          <center><button class="btn btn-secondary" onClick="location.href='view_newmovimientos.php'">Acciones de Usuario</button></center>
        </div>
        <div class="col-2">
