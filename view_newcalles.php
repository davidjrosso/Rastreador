  ...
  <div class = "col-md-3">
    ...
    <i class="fa fa-bars fa-2x toggle-btn" data-toggle="collapse" data-target="#menu-content"></i>
        ...
        <div class="menu-list">
            ...
            <?php $Element = new Elements();
            $Element->getMenuActualizaciones(9);?>
        </div>
  ...
  <div class = "col-md-9">
    ...
    <br>
     <div class = "row">
      <div class = "col-10">
          <!-- Carga -->
          <p class = "Titulos">Cargar Nueva Calle</p>
          <form method = "post" onKeydown="return event.key != 'Enter';" action = "Controladores/InsertCalle.php">
            <div class="form-group row">
              <label for="inputPassword" class="col-md-2 col-form-label LblForm">Calle *: </label>
              <div class="col-md-10">
                <input type="text" class="form-control" name = "Calle" id="Calle" autocomplete="off" required>
              </div>
            </div>
            <div class="form-group row">
              <div class="offset-md-2 col-md-10">
                <button type="submit" class="btn btn-outline-success">Guardar</button>
                <button type = "button" class = "btn btn-danger" onClick = "location.href = 'view_calles.php'">Atras</button>
              </div>
            </div>
          </form>
          <div class="row">
