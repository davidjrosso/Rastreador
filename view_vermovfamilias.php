      ...
      <div class = "col-10">
        ...
        <div class = "row">
          <?php  
              ...
              $ConsultarMovimientos = "select M.id_movimiento, M.fecha, P.domicilio, P.apellido, P.nombre, P.edad, P.meses, P.domicilio, M.motivo_1, M.motivo_2, M.motivo_3, M.observaciones, R.responsable from movimiento M, responsable R, persona P, motivo MO, categoria C where M.id_resp = R.id_resp and M.id_persona = P.id_persona and M.estado = 1";

              if($Domicilio != null && $Domicilio != ""){
                $ConsultarMovimientos .= " and P.domicilio like '%$Domicilio%'";
              }
              ...
              $TomarMovimientosFamilias = mysqli_query($Con->Conexion,$ConsultarMovimientos) or die($MensajeErrorMovimientos);

              $Rows = mysqli_num_rows($TomarMovimientosFamilias);

              if($Rows == 0){
                echo "<div class = 'col'></div>";
                echo "<div class = 'col-6'>";
                echo "<p class = 'TextoSinResultados'>No se encontraron Resultados</p><center><button class = 'btn btn-danger' onClick = 'location.href= \"view_movfamilias.php\"'>Atras</button></center>";
                echo "</div>";
                echo "<div class = 'col'></div>";
              }

              while ($RetMovimientos = mysqli_fetch_assoc($TomarMovimientosFamilias)) {
                ...
                $TableMov .= "<tr><td style = 'width: 30%;'>Domicilio</td><td style = 'width: 70%;'>".$Domicilio."</td></tr>";
