...
<div class = "row" style="margin-right: 0px;margin-left: 0px;">
  ...
  <div class = "col-md-8">
    ...
    <br>
     <div class = "row">
      <div class = "col-10">
          <form method = "post" onKeydown="return event.key != 'Enter';" action = "Controladores/modificacionpassword.php">
            <div class="form-group row">
              <label for="password" style="text-align:center;" class="col-md-2 col-form-label LblForm">Contraseña</label>
              <div class="col-md-10">
                <input type="text" class="form-control" name="password" id="password" autofocus autocomplete="off" placeholder="contraseña">
              </div>
            </div>
