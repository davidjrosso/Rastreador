    ...
    <br>
     <div class = "row">
      <div class = "col-10">
          ...
          <form method = "post" action = "view_rep_general_new2.php" onSubmit = "return ValidarGeneral();">
            ...
            <div class="form-group row">
              <label for="inputPassword" class="col-md-2 col-form-label LblForm">Mostrar: </label>
              <div class="col-md-10">
			        	...
			        	<div class="row">
			        		...
			        		<div class="col-8">
			        			<div class="input-group mb-3">
				        			<input class = "form-control" type="text" name="BuscarPersona" id = "SearchPersonas" onKeyUp="buscarPersonas()" autocomplete="off">
