  ...
  <div class = "col-md-9">
    <div class="row">
      ...
      <div class="col-10 Titulo">
        <p>Actualización de Centros de Salud</p>
      </div>
      <div class="col"></div>
    </div><br>
    <div class="row">
      <div class = "col"></div>
      <div class = "col-4">
          <center><button class = "btn btn-secondary" onClick = "location.href='/centrodesalud/nuevo'">Agregar Nuevo Centro de Salud</button></center>
      </div>
      <div class="col-2">
        ...
        <div class = "row">
          <?php  
            if(isset($_REQUEST["Filtro"]) && $_REQUEST["Filtro"]!=null){
              ...
              switch ($ID_Filtro) {
                case 'ID': echo $DTGeneral->getCentrosxID($Filtro);break;
                case 'Centro': echo $DTGeneral->getCentrosxCentro($Filtro);break;
                default: echo $DTGeneral->getCentrosxID($Filtro);break;
              }
            }else{
              $DTGeneral = new CtrGeneral();
              echo $DTGeneral->getCentros();
            }
          ?>
        </div>
  </div>
