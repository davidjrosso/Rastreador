      ...
      <div class = "col-8">
          ...
          <form method = "post" action = "#">
            <div class="form-group row">
              ...
              <div class="col-md-10">
                <input type="password" class="form-control" name = "NombreComb" id="inputPassword" placeholder="Name" width="100%">
              </div>
            </div>
            <div class="form-group row">
              <label for="inputPassword" class="col-md-2 col-form-label LblForm">Precio por Litro: </label>
              <div class="col-md-10">
                <input type="password" class="form-control" name = "Precio" id="inputPassword" placeholder="Price" width="100%">
              </div>
            </div>
            <div class="form-group row">
