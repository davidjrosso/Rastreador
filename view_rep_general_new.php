                                ...
                                && ($RetTodos["Anio"] == $value["anio"])) {
                                    ...
                                    if (($CantOpMotivos == 0) || $motivo) {
                                          ...
                                          $tagsTD .= "<div class = 'col-md-2' style = 'padding: 0; text-align: center; " . $value["div_hidden"] . "'>
                                                        <a style='text-decoration: none;' href = 'javascript:window.open(\"/movimiento?ID=" . $RetTodos["id_movimiento"] . "\",\"Ventana" . $RetTodos["id_movimiento"] . "\",\"width=1100,height=500,scrollbars=no,top=150,left=250,resizable=no\")'>
    ...
    <div class="class_modal-dialog modal-dialog" role="document" id="id_modal-dialog"
      ...
      <div class="modal-content" style="height: 60%;">
        <div>
          ...
          <!--<button type="button" id="boton-multi-decrement" class="button-min" aria-label="min" aria-label="multi-decrement">
          ...
          <!--<button type="button" id="boton-multi-increment" class="button-min" aria-label="multi-increment">
