              ...
              */
              ...
              foreach ($tomarRetTodos as $clave => $RetTodos) {
                ...
                if ($RetTodos["tipo"] == "SM") {
                  ...
                  $tagsTD .= "<td id='Contenido-1'>" . $RetTodos["Barrio"] . "</td><td id='Contenido-2'>" . $RetTodos["domicilio"] . "</td>";
                  $tagsTD_imprimir .= "<td id='Contenido-1'>" . $RetTodos["Barrio"] . "</td><td id='Contenido-2'>" . $RetTodos["domicilio"] . "</td>";

                  if ($cmb_seleccion != null && $cmb_seleccion != "") {

                    if ($cmb_seleccion == "manzana") {
                      $tagsTD .= "<td id='Contenido-3' name='datosflia' style='max-width: 50px;'>" . $RetTodos["manzana"] . "</td>";
                      $tagsTD_imprimir .= "<td id='Contenido-3' name='datosflia' style='max-width: 50px;'>" . $RetTodos["manzana"] . "</td>";
                    }

                    if ($cmb_seleccion == "lote") {
                      $tagsTD .= "<td id='Contenido-4' name='datosflia' style='max-width: 50px;'>" . $RetTodos["lote"] . "</td>";
                      $tagsTD_imprimir .= "<td id='Contenido-4' name='datosflia' style='max-width: 50px;'>" . $RetTodos["lote"] . "</td>";
                    }

                    if ($cmb_seleccion == "familia") {
                      $tagsTD .= "<td id='Contenido-5' name='datosflia' style='max-width: 60px;'>" . $RetTodos["familia"] . "</td>";
                      $tagsTD_imprimir .= "<td id='Contenido-5' name='datosflia' style='max-width: 60px;'>" . $RetTodos["familia"] . "</td>";
                    }
                  ...
                  $tagsTD_imprimir .= " <td id='Contenido-3'>". $RetTodos["apellido"] . ", " . $RetTodos["nombre"] . "</td>
                                       <td id='Contenido-4' style='min-width: 150px;'>" . $Fecha_Nacimiento . "</td>";
                  // if($ID_Persona_Nuevo !== $ID_Persona_Bandera){
                  foreach ($arr as $key => $value) {
                    $Separar = explode("/", $value);
                    ...
                    $tagsTD .= "<td name='DatosResultados' id=$IndexCelda style='min-width:190px'><div class = 'row' style='margin:0'>";                  //250   
                    $tagsTD_imprimir .= "<td name='DatosResultados' style='min-width:190px'><div class = 'row' style='margin:0'>";
                    $Num_Movimientos_Persona = mysqli_num_rows($Tomar_Movimientos_Persona);
                      ...
                      if ($Ret_Datos_Movimiento["motivo_1"] > 1) {
                        if ($ID_Motivo > 0) {
                          if ($ID_Motivo == $Ret_Datos_Movimiento["motivo_1"]) {
                            ...
                            if($RetMotivo["ConPermisoParaUsr"] == "1" || $RetMotivo["ConPermisoGeneral"] == "1"){
                              ...
                              $tagsTD_imprimir .= "<div class = 'col-md-2' style = 'padding: 0; text-align: center;'>
                                                      <span style='font-family: DejaVu Sans, Noto Sans Symbols 2; font-size: 10px; color: " . $RetMotivo["color"] . ";'>" . 
                                                        $RetMotivo["Forma_Categoria"] . 
                                                        "<center>
                                                          <span class='nombreCategoria'>" . $RetMotivo["codigo"] . "
                                                          </span>
                        ...
                        if ($ID_Motivo2 > 0) {
                          if ($ID_Motivo2 == $Ret_Datos_Movimiento["motivo_1"]) {
                            ...
                            if($RetMotivo["ConPermisoParaUsr"] == "1" || $RetMotivo["ConPermisoGeneral"] == "1"){
                              $tagsTD .= "<div class = 'col-md-2' style = 'padding: 0; text-align: center;'>
                                            <a style='text-decoration: none;' href = 'javascript:window.open(\"view_vermovimientos.php?ID=" . $Ret_Datos_Movimiento["id_movimiento"] . "\",\"Ventana" . $Ret_Datos_Movimiento["id_movimiento"] . "\",\"width=800,height=500,scrollbars=no,top=150,left=250,resizable=no\")'>
                                              <span style='font-size: 30px; color: " . $RetMotivo["color"] . ";'>" . $RetMotivo["Forma_Categoria"] . "
                                                <center>
                                                  <span class='nombreCategoria'>" . $RetMotivo["codigo"] . "
                                                  </span>
                                                </center>
                        ...
                        if ($ID_Motivo3 > 0) {
                          if ($ID_Motivo3 == $Ret_Datos_Movimiento["motivo_1"]) {
                            ...
                            if($RetMotivo["ConPermisoParaUsr"] == "1" || $RetMotivo["ConPermisoGeneral"] == "1"){
                                ...
                                $tagsTD_imprimir .= "<div class = 'col-md-2' style = 'padding: 0; text-align: center;'>
                                                      <span style='font-family: DejaVu Sans, Noto Sans Symbols 2; font-size:  10px; color: " . $RetMotivo["color"] . "; '>" . $RetMotivo["Forma_Categoria"] . "
                                                        <center>
                                                          <span class='nombreCategoria' >" . $RetMotivo["codigo"] . "
                                                          </span>
                                                        </center>
                        ...
                        if ($ID_Motivo == 0 && $ID_Motivo2 == 0 && $ID_Motivo3 == 0) {
                          ...
                          if($RetMotivo["ConPermisoParaUsr"] == "1" || $RetMotivo["ConPermisoGeneral"] == "1"){
                              $tagsTD .= "<div class = 'col-md-2' style = 'padding: 0; text-align: center;'>
                                            <a style='text-decoration: none;' href = 'javascript:window.open(\"view_vermovimientos.php?ID=" . $Ret_Datos_Movimiento["id_movimiento"] . "\",\"Ventana" . $Ret_Datos_Movimiento["id_movimiento"] . "\",\"width=800,height=500,scrollbars=no,top=150,left=250,resizable=no\")'>
                                              <span style='font-size: 30px; padding: 0px; color: " . $RetMotivo["color"] . ";'>" . $RetMotivo["Forma_Categoria"] . "
                                                <center>
                              ...
                              $tagsTD_imprimir .= "<div class = 'col-md-2' style = 'padding: 0; text-align: center;'>
                                                    <span style='font-family: DejaVu Sans, Noto Sans Symbols 2; font-size: 10px; padding: 0px; color: " . $RetMotivo["color"] . ";'>" . $RetMotivo["Forma_Categoria"] . "
                                                      <center>
                                                        <span class='nombreCategoria' >" . $RetMotivo["codigo"] . "
                                                        </span>
                                                      </center>
                      ...
                      if ($Ret_Datos_Movimiento["motivo_2"] > 1) {
                        if ($ID_Motivo > 0) {
                          if ($ID_Motivo == $Ret_Datos_Movimiento["motivo_2"]) {
                            ...
                            if($RetMotivo["ConPermisoParaUsr"] == "1" || $RetMotivo["ConPermisoGeneral"] == "1"){
                                ...
                                $tagsTD_imprimir .=  "<div class = 'col-md-2' style = 'padding: 0; text-align: center;'>
                                                        <span style='font-family: DejaVu Sans, Noto Sans Symbols 2;font-size: 10px; padding: 0px; color: " . $RetMotivo2["color"] . ";'>" . $RetMotivo2["Forma_Categoria"] . "
                                                          <center>
                                                            <span class='nombreCategoria' >" . $RetMotivo2["codigo"] . "
                                                            </span>
                                                          </center>
                        ...
                        if ($ID_Motivo2 > 0) {
                          if ($ID_Motivo2 == $Ret_Datos_Movimiento["motivo_2"]) {
                            ...
                            if($RetMotivo["ConPermisoParaUsr"] == "1" || $RetMotivo["ConPermisoGeneral"] == "1"){
                                ...
                                $tagsTD_imprimir .= "<div class = 'col-md-2' style = 'padding: 0; text-align: center;'>
                                                      <span style=' font-family: DejaVu Sans, Noto Sans Symbols 2; font-size:  10px;  color: " . $RetMotivo2["color"] . ";'>" . $RetMotivo2["Forma_Categoria"] . "<center><span class='nombreCategoria' >" . $RetMotivo2["codigo"] . "</span></center></span></div>";
                            }
                          }
                        }
                        if ($ID_Motivo3 > 0) {
                          if ($ID_Motivo3 == $Ret_Datos_Movimiento["motivo_2"]) {
                            ...
                            if($RetMotivo["ConPermisoParaUsr"] == "1" || $RetMotivo["ConPermisoGeneral"] == "1"){
                              ...
                              $tagsTD_imprimir .= "<div class = 'col-md-2' style = 'padding: 0; text-align: center;'>
                                                    <span style=' font-family: DejaVu Sans, Noto Sans Symbols 2; font-size:  10px;  color: " . $RetMotivo2["color"] . ";'>" . 
                                                      $RetMotivo2["Forma_Categoria"] . "
                                                      <center>
                                                        <span class='nombreCategoria' >" . 
                                                          $RetMotivo2["codigo"] . "
                        ...
                        if ($ID_Motivo == 0 && $ID_Motivo2 == 0 && $ID_Motivo3 == 0) {
                          ...
                          if($RetMotivo["ConPermisoParaUsr"] == "1" || $RetMotivo["ConPermisoGeneral"] == "1"){
                            ...
                            $tagsTD_imprimir .= "<div class = 'col-md-2' style = 'padding: 0; text-align: center;'><span style=' font-family: DejaVu Sans, Noto Sans Symbols 2; font-size:  10px;  color: " . $RetMotivo2["color"] . "; text-align= center;'>" . $RetMotivo2["Forma_Categoria"] . "<center><span class='nombreCategoria' >" . $RetMotivo2["codigo"] . "</span></center></span></div>";
                          }
                        }
                      }
                        ...
                        if ($ID_Motivo > 0) {
                          if ($ID_Motivo == $Ret_Datos_Movimiento["motivo_3"]) {
                            ...
                            if($RetMotivo["ConPermisoParaUsr"] == "1" || $RetMotivo["ConPermisoGeneral"] == "1"){
                                ...
                                $tagsTD_imprimir .= "<div class = 'col-md-2' style = 'padding: 0; text-align: center;'><span style=' font-family: DejaVu Sans, Noto Sans Symbols 2; font-size:  10px;  color: " . $RetMotivo3["color"] . ";'>" . $RetMotivo3["Forma_Categoria"] . "<center><span class='nombreCategoria' >" . $RetMotivo3["codigo"] . "</span></center></span></div>";
                            }
                          }
                        }
                        if ($ID_Motivo2 > 0) {
