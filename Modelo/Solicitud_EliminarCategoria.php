...
class Solicitud_EliminarCategoria
{
    ...
    public static function get_categorias(){
        ...
        $rs = mysqli_query($con->Conexion,$consulta) or die("Problemas al consultar las soli.");
        $lista_acciones = [];
    ...
    public static function get_id_categoria_sl($coneccion, $id)
    {
        ...
        $consulta = "SELECT *
						 ...
						 WHERE ID_Categoria = " . $id . " 
						   AND Estado = 1";
        $rs = mysqli_query($coneccion->Conexion,$consulta) or die("Problemas al consultar las soli.");
    ...
    function delete()
    {
        $consulta = "update solicitudes_eliminarcategorias
                     set Estado = 0
                     where ID = " . $this->getID();
