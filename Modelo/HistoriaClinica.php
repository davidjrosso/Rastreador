...
class HistoriaClinica implements JsonSerializable
{
	...
	public function __construct(
        ...
        if (!$id_historia_clinica) {
			...
			$EjecutarConsultarPersona = mysqli_query(
				...
				$ConsultarPersona) or die("Problemas al consultar filtro Historia Clinica");
    ...
    public function update_NroCarpeta()
    {
        ...
        $Consulta = "update historias_clinicas 
                    ...
                    $MensajeErrorConsultar = "No se pudo actualizar la Historia Clinica";
    ...
    public function save()
    {
        ...
        $consulta = "INSERT INTO historias_clinicas (
                    ...
                    $MensajeErrorConsultar = "No se pudo insertar la Historia Clinica";
