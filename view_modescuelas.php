        ...
        <div class = "row">
          <?php  
            if(isset($_REQUEST["ID"]) && $_REQUEST["ID"]!=null){
              ...
              ?>
            <div class = "col-10">
            <form method = "post" onKeydown="return event.key != 'Enter';" action = "Controladores/ModificarEscuela.php">
                <div class="form-group row">
                  <label for="inputPassword" class="col-md-2 col-form-label LblForm">Id: </label>
                  <div class="col-md-10">
                    <label for="inputPassword" class="col-md-2 col-form-label LblForm"><?php echo $InstEscuela->getID_Escuela(); ?></label>
                    <input type="hidden" name="ID" value = "<?php echo $InstEscuela->getID_Escuela(); ?>">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="inputPassword" class="col-md-2 col-form-label LblForm">Codigo: </label>
                  <div class="col-md-10">
                    <input type="text" class="form-control" name = "Codigo" id="inputPassword" autocomplete="off" value = "<?php echo $InstEscuela->getCodigo(); ?>" required>
                  </div>
                </div>
                <div class="form-group row">
                  <label for="inputPassword" class="col-md-2 col-form-label LblForm">Escuela: </label>
                  <div class="col-md-10">
                    <input type="text" class="form-control" name = "Escuela" id="inputPassword" autocomplete="off" value = "<?php echo $InstEscuela->getEscuela(); ?>" required>
                  </div>
                </div>
                <div class="form-group row">
                  <label for="inputPassword" class="col-md-2 col-form-label LblForm">CUE: </label>
                  <div class="col-md-10">
                    <input type="text" class="form-control" name = "CUE" id="inputPassword" autocomplete="off" value = "<?php echo $InstEscuela->getCUE(); ?>">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="inputPassword" class="col-md-2 col-form-label LblForm">Localidad: </label>
                  <div class="col-md-10">
                    <input type="text" class="form-control" name = "Localidad" id="inputPassword" autocomplete="off" value = "<?php echo $InstEscuela->getLocalidad(); ?>">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="inputPassword" class="col-md-2 col-form-label LblForm">Departamento: </label>
                  <div class="col-md-10">
                    <input type="text" class="form-control" name = "Departamento" id="inputPassword" autocomplete="off" value = "<?php echo $InstEscuela->getDepartamento(); ?>">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="inputPassword" class="col-md-2 col-form-label LblForm">Directora: </label>
                  <div class="col-md-10">
                    <input type="text" class="form-control" name = "Directora" id="inputPassword" autocomplete="off" value = "<?php echo $InstEscuela->getDirectora(); ?>">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="inputPassword" class="col-md-2 col-form-label LblForm">Telefono: </label>
                  <div class="col-md-10">
                    <input type="text" class="form-control" name = "Telefono" id="inputPassword" autocomplete="off" value = "<?php echo $InstEscuela->getTelefono(); ?>">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="inputPassword" class="col-md-2 col-form-label LblForm">Mail: </label>
                  <div class="col-md-10">
                    <input type="text" class="form-control" name = "Mail" id="inputPassword" autocomplete="off" value = "<?php echo $InstEscuela->getMail(); ?>">
                  </div>
                </div>
                <div class="form-group row">
            ...
            <div class="row">
                ...
                <div class="col-2">
                  <button type = "button" class = "btn btn-outline-secondary" onClick = "location.href = 'view_escuelas.php'">Volver</button>
                </div>
            </div>
            </div>
              <?php  
            }else{
              $Mensaje = "No se pudo consultar los Datos porque no se pudo obtener el ID de la Escuela";
              echo $Mensaje;
            }
          ?>
        </div>        
