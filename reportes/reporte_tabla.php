...
$Consulta = urldecode($_REQUEST["Consulta"]);
$Anio = $_REQUEST["Anio"];
$MensajeError = "No se pudo realizar correctamente la consulta a la base de datos";

echo "<p class = 'Titulo'>RESUMEN</p>";

$EjecutarConsulta = mysqli_query($Con->Conexion, $Consulta);

$Table =  "<center><table class='reporte-tabla' style='width: 500px;' cellspacing='0'
  width='100%' id = 'DivTab'><thead class = 'bg-secondary' style='color: #000;'><tr align='center' valign='middle'></th><th>Enero</th><th>Febrero</th><th>Marzo</th><th>Abril</th><th>Mayo</th><th>Junio</th><th>Julio</th><th>Agosto</th><th>Septiembre</th><th>Octubre</th><th>Noviembre</th><th>Diciembre</th></tr></thead>";
    ...
    */
    ...
    while ($RetEnero = mysqli_fetch_assoc($Tomar_Enero)) {
      /////////////////////////////////////////////////////////////////////////////////////////
        ...
        $Table .= "<center><div class = 'row container' style = 'width: 60px;'>";

        $Table .= "<div style='display:inline-block; cursor:pointer; width:10px;height:10px; border-radius: 30%; color: white; background-color: ".$RetMotivo_1["color"].";' onClick='javascript:window.open(\"../view_vermovimientos.php?ID=".$RetEnero["id_movimiento"]."\",\"Ventana".$RetEnero["id_movimiento"]."\",\"width=800,height=500,scrollbars=no,top=150,left=250,resizable=no\")' title='Registro: (".$Ret["apellido"].", ".$Ret["nombre"].") ".$RetMotivo_1["cod_categoria"]."'></div>";
      ...
      if($RetEnero["motivo_2"] > 1){
        ...
        $Table .= " <div style='display:inline-block; cursor:pointer; width:10px;height:10px; border-radius: 30%; color: white; background-color: ".$RetMotivo_2["color"].";' onClick='javascript:window.open(\"../view_vermovimientos.php?ID=".$RetEnero["id_movimiento"]."\",\"Ventana".$RetEnero["id_movimiento"]."\",\"width=800,height=500,scrollbars=no,top=150,left=250,resizable=no\")' title='Registro: (".$Ret["apellido"].", ".$Ret["nombre"].") ".$RetMotivo_2["cod_categoria"]."'></div> ";
      ...
      if($RetMotivo_3 > 1){                    
        ...
        $Table .= "<div style='display:inline-block; cursor:pointer; width:10px;height:10px; border-radius: 30%; color: white; background-color: ".$RetMotivo_3["color"].";' onClick='javascript:window.open(\"../view_vermovimientos.php?ID=".$RetEnero["id_movimiento"]."\",\"Ventana".$RetEnero["id_movimiento"]."\",\"width=800,height=500,scrollbars=no,top=150,left=250,resizable=no\")' title='Registro: (".$Ret["apellido"].", ".$Ret["nombre"].") ".$RetMotivo_3["cod_categoria"]."'></div>";
    ...
    while ($RetFebrero = mysqli_fetch_assoc($Tomar_Febrero)) {                                    
        ...
        $Table .= "<div style='display:inline-block; cursor:pointer; width:10px;height:10px; border-radius: 30%; color: white; background-color: ".$RetMotivo_1["color"].";' onClick='javascript:window.open(\"../view_vermovimientos.php?ID=".$RetFebrero["id_movimiento"]."\",\"Ventana".$RetFebrero["id_movimiento"]."\",\"width=800,height=500,scrollbars=no,top=150,left=250,resizable=no\")' title='Registro de: (".$Ret["apellido"].", ".$Ret["nombre"].") ".$RetMotivo_1["cod_categoria"]."'></div>";
        ...
        $Table .= " <div style='display:inline-block; cursor:pointer; width:10px;height:10px; border-radius: 30%; color: white; background-color: ".$RetMotivo_2["color"].";' onClick='javascript:window.open(\"../view_vermovimientos.php?ID=".$RetFebrero["id_movimiento"]."\",\"Ventana".$RetFebrero["id_movimiento"]."\",\"width=800,height=500,scrollbars=no,top=150,left=250,resizable=no\")' title='Registro de: (".$Ret["apellido"].", ".$Ret["nombre"].") ".$RetMotivo_2["cod_categoria"]."'></div> ";
        ...
        $Table .= "<div style='display:inline-block; cursor:pointer; width:10px;height:10px; border-radius: 30%; color: white; background-color: ".$RetMotivo_3["color"].";' onClick='javascript:window.open(\"../view_vermovimientos.php?ID=".$RetFebrero["id_movimiento"]."\",\"Ventana".$RetFebrero["id_movimiento"]."\",\"width=800,height=500,scrollbars=no,top=150,left=250,resizable=no\")' title='Registro de: (".$Ret["apellido"].", ".$Ret["nombre"].") ".$RetMotivo_3["cod_categoria"]."'></div>";
    ...
    while ($RetMarzo = mysqli_fetch_assoc($Tomar_Marzo)) {              
        ...
        $Table .= "<div style='display:inline-block; cursor:pointer; width:10px;height:10px; border-radius: 30%; color: white; background-color: ".$RetMotivo_1["color"].";' onClick='javascript:window.open(\"../view_vermovimientos.php?ID=".$RetMarzo["id_movimiento"]."\",\"Ventana".$RetMarzo["id_movimiento"]."\",\"width=800,height=500,scrollbars=no,top=150,left=250,resizable=no\")' title='Registro de: (".$Ret["apellido"].", ".$Ret["nombre"].") ".$RetMotivo_1["cod_categoria"]."'></div>";
    ...
    while ($RetAbril = mysqli_fetch_assoc($Tomar_Abril)) {               
        ...
        $Table .= "<div style='display:inline-block; cursor:pointer; width:10px;height:10px; border-radius: 30%; color: white; background-color: ".$RetMotivo_1["color"].";' onClick='javascript:window.open(\"../view_vermovimientos.php?ID=".$RetAbril["id_movimiento"]."\",\"Ventana".$RetAbril["id_movimiento"]."\",\"width=800,height=500,scrollbars=no,top=150,left=250,resizable=no\")' title='Registro de: (".$Ret["apellido"].", ".$Ret["nombre"].") ".$RetMotivo_1["cod_categoria"]."'></div>";
    ...
    while ($RetMayo = mysqli_fetch_assoc($Tomar_Mayo)) {              
        ...
        $Table .= "<div style='display:inline-block; cursor:pointer; width:10px;height:10px; border-radius: 30%; color: white; background-color: ".$RetMotivo_1["color"].";' onClick='javascript:window.open(\"../view_vermovimientos.php?ID=".$RetMayo["id_movimiento"]."\",\"Ventana".$RetMayo["id_movimiento"]."\",\"width=800,height=500,scrollbars=no,top=150,left=250,resizable=no\")' title='Registro de: (".$Ret["apellido"].", ".$Ret["nombre"].") ".$RetMotivo_1["cod_categoria"]."'></div>";
    ...
    while ($RetJunio = mysqli_fetch_assoc($Tomar_Junio)) {               
        ...
        $Table .= "<div style='display:inline-block; cursor:pointer; width:10px;height:10px; border-radius: 30%; color: white; background-color: ".$RetMotivo_1["color"].";' onClick='javascript:window.open(\"../view_vermovimientos.php?ID=".$RetJunio["id_movimiento"]."\",\"Ventana".$RetJunio["id_movimiento"]."\",\"width=800,height=500,scrollbars=no,top=150,left=250,resizable=no\")' title='Registro de: (".$Ret["apellido"].", ".$Ret["nombre"].") ".$RetMotivo_1["cod_categoria"]."'></div>";
    ...
    while ($RetJulio = mysqli_fetch_assoc($Tomar_Julio)) {             
        ...
        $Table .= "<div style='display:inline-block; cursor:pointer; width:10px;height:10px; border-radius: 30%; color: white; background-color: ".$RetMotivo_1["color"].";' onClick='javascript:window.open(\"../view_vermovimientos.php?ID=".$RetJulio["id_movimiento"]."\",\"Ventana".$RetJulio["id_movimiento"]."\",\"width=800,height=500,scrollbars=no,top=150,left=250,resizable=no\")' title='Registro de: (".$Ret["apellido"].", ".$Ret["nombre"].") ".$RetMotivo_1["cod_categoria"]."'></div>";
    ...
    while ($RetAgosto = mysqli_fetch_assoc($Tomar_Agosto)) {              
        ...
        */
        ...
        $Table .= "<div style='display:inline-block; cursor:pointer; width:10px;height:10px; border-radius: 30%; color: white; background-color: ".$RetMotivo_1["color"].";' onClick='javascript:window.open(\"../view_vermovimientos.php?ID=".$RetAgosto["id_movimiento"]."\",\"Ventana".$RetAgosto["id_movimiento"]."\",\"width=800,height=500,scrollbars=no,top=150,left=250,resizable=no\")' title='Registro de: (".$Ret["apellido"].", ".$Ret["nombre"].") ".$RetMotivo_1["cod_categoria"]."'></div>";
    ...
    while ($RetSeptiembre = mysqli_fetch_assoc($Tomar_Septiembre)) {           
        ...
        $Table .= "<div style='display:inline-block; cursor:pointer; width:10px;height:10px; border-radius: 30%; color: white; background-color: ".$RetMotivo_1["color"].";' onClick='javascript:window.open(\"../view_vermovimientos.php?ID=".$RetSeptiembre["id_movimiento"]."\",\"Ventana".$RetSeptiembre["id_movimiento"]."\",\"width=800,height=500,scrollbars=no,top=150,left=250,resizable=no\")' title='Registro de: (".$Ret["apellido"].", ".$Ret["nombre"].") ".$RetMotivo_1["cod_categoria"]."'></div>";
    ...
    while ($RetOctubre = mysqli_fetch_assoc($Tomar_Octubre)) {              
        ...
        $Table .= "<div style='display:inline-block; cursor:pointer; width:10px;height:10px; border-radius: 30%; color: white; background-color: ".$RetMotivo_1["color"].";' onClick='javascript:window.open(\"../view_vermovimientos.php?ID=".$RetOctubre["id_movimiento"]."\",\"Ventana".$RetOctubre["id_movimiento"]."\",\"width=800,height=500,scrollbars=no,top=150,left=250,resizable=no\")' title='Registro de: (".$Ret["apellido"].", ".$Ret["nombre"].") ".$RetMotivo_1["cod_categoria"]."'></div>";
    ...
    while ($RetNoviembre = mysqli_fetch_assoc($Tomar_Noviembre)) {                                   
        ...
        $Table .= "<div style='display:inline-block; cursor:pointer; width:10px;height:10px; border-radius: 30%; color: white; background-color: ".$RetMotivo_1["color"].";' onClick='javascript:window.open(\"../view_vermovimientos.php?ID=".$RetNoviembre["id_movimiento"]."\",\"Ventana".$RetNoviembre["id_movimiento"]."\",\"width=800,height=500,scrollbars=no,top=150,left=250,resizable=no\")' title='Registro de: (".$Ret["apellido"].", ".$Ret["nombre"].") ".$RetMotivo_1["cod_categoria"]."'></div>";
    ...
    while ($RetDiciembre = mysqli_fetch_assoc($Tomar_Diciembre)) {              
        ...
        */
        ...
        $Table .= "<div style='display:inline-block; cursor:pointer; width:10px;height:10px; border-radius: 30%; color: white; background-color: ".$RetMotivo_1["color"].";' onClick='javascript:window.open(\"../view_vermovimientos.php?ID=".$RetDiciembre["id_movimiento"]."\",\"Ventana".$RetDiciembre["id_movimiento"]."\",\"width=800,height=500,scrollbars=no,top=150,left=250,resizable=no\")' title='Registro de: (".$Ret["apellido"].", ".$Ret["nombre"].") ".$RetMotivo_1["cod_categoria"]."'></div>";
        ...
        */
        ...
        $Table .= " <div style='cursor:pointer; width:10px;height:10px; border-radius: 30%; color: white; background-color: ".$RetMotivo_2["color"].";' onClick='javascript:window.open(\"../view_vermovimientos.php?ID=".$RetDiciembre["id_movimiento"]."\",\"Ventana".$RetDiciembre["id_movimiento"]."\",\"width=800,height=500,scrollbars=no,top=150,left=250,resizable=no\")' title='Registro de: (".$Ret["apellido"].", ".$Ret["nombre"].") ".$RetMotivo_2["cod_categoria"]."'></div> ";
        ...
        $Table .= "<div style='cursor:pointer; width:10px;height:10px; border-radius: 30%; color: white; background-color: ".$RetMotivo_3["color"].";' onClick='javascript:window.open(\"../view_vermovimientos.php?ID=".$RetDiciembre["id_movimiento"]."\",\"Ventana".$RetDiciembre["id_movimiento"]."\",\"width=800,height=500,scrollbars=no,top=150,left=250,resizable=no\")' title='Registro de: (".$Ret["apellido"].", ".$Ret["nombre"].") ".$RetMotivo_3["cod_categoria"]."'></div>";
